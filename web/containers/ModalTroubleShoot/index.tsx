  ...
  return (
    <Modal open={modalTroubleShooting} onOpenChange={setModalTroubleShooting}>
      <ModalContent className="max-w-[60%] pb-4 pt-8">
        ...
        <div className="border-border rounded-lg border p-4 shadow">
        ...
        <div className="border-border block overflow-hidden rounded-lg border pb-2 pt-4 shadow">
          <div className="px-4">
                ...
                {logOption.map((name, i) => {
                  return (
                    ...
                    >
                      ...
                      {isTabActive === i && (
                        <m.div
                          className="bg-background absolute left-0 top-1 h-[calc(100%-8px)] w-full rounded-md dark:bg-white"
