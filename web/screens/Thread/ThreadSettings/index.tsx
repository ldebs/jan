      ...
      <ScrollArea className={styles.listPanel}>
        <div className="p-4">
          <p>
            ...
            perspiciatis rem, quo culpa reiciendis repellat blanditiis eligendi
            accusantium nam? Recusandae dolore unde, nemo architecto dolor
            possimus accusamus praesentium dolorem.
          </p>
        </div>
